...
class AsyncReviews(AsyncEndpoint):
    ...
    async def add_reviewer(
        ...
        *,
        ...
        await self._request("POST", f"/api/v2/documents/{document_id}/reviews/requests", json=body)
    ...
    async def remove_reviewer(
        ...
        *,
        ...
        if group_to_name is not None:
            body["group_to_name"] = group_to_name
        await self._request("DELETE", f"/api/v2/documents/{document_id}/reviews/requests", json=body)
